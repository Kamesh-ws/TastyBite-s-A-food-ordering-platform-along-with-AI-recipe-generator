...
const MenuNew = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("http://localhost:4000/api/special-dish", formData, {
                headers: {
                    token: `${token}`,
    ...
    return (
        <div className='flex items-center p-2 justify-center mt-10'>
            ...
            <form className='form-container relative' onSubmit={handleSubmit}>
                ...
                <h1 className='logo'>New Special Dish</h1>
                ...
                <button className='button' type='submit' disabled={isLoading}>
                    {isLoading ? 'Creating...' : 'Create Special Dish'}
                </button>
            </form>
        </div>
    );
